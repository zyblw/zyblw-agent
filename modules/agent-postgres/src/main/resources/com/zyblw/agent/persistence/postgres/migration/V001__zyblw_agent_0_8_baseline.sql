...
CREATE TABLE agent_memory_audit (
  ...
  action TEXT NOT NULL CHECK (action IN ('read', 'list', 'search', 'correct', 'delete', 'delete_scope', 'retention_purge', 'export')),
...
CREATE TABLE agent_eval_snapshots (
  ...
  suite_kind TEXT NOT NULL CHECK (suite_kind IN ('Agent', 'AgentReliability', 'HarnessComparison', 'Rag', 'ContextCompression')),
